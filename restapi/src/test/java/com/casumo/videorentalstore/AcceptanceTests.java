...
public class AcceptanceTests {
	...
	public void shouldRentSeveralFilmsAndCalculatePrice() {
		...
		// SEK
		RentalItemRequest item1 = new RentalItemRequest(UUID.fromString("ec5cbcd9-08b3-466e-8f76-a40c29bb1738"), 5);

		// The Godfather :: Old film :: 6 days rental :: 30 + 30 SEK
		RentalItemRequest item2 = new RentalItemRequest(UUID.fromString("92d6e75a-ee87-47ef-9178-8ee3f797d5ca"), 6);

		// Avengers: Infinity War :: New release film :: 2 days rental :: 2 * 40
		// SEK
		RentalItemRequest item3 = new RentalItemRequest(UUID.fromString("9bef5979-7249-44eb-ae5d-ef6d54cba9b4"), 2);
	...
	public void shouldAllowReturnFilmsAndCalculateSurcharges() {
		...
		RentalItemRequest item = new RentalItemRequest(movieId, 5);
